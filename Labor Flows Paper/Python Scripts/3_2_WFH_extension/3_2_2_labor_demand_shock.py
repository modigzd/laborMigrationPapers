...
## Set base seed
seed = 202207
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\3_2_WFH_extension\3_2_2_labor_demand_shock'
...
for ii in range(runs):   
    ...
    for f in world.Firms.values():
        ...
        if f.sector == 'unskilled':
            
            new_tol = np.random.normal(-.05, .075)
        
        elif f.sector == 'skilled':
...
"""
Case 2: High k, Even number of skilled/unskilled workers
"""
for ii in range(runs):   
...
"""
Case 3: Low k, More unskilled than skilled workers
"""
for ii in range(runs):   
...
"""
Case 4: Low k, More unskilled than skilled workers
"""
for ii in range(runs):   
