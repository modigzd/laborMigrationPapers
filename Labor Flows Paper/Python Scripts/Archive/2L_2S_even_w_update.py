...
This script is unchanged from the original, but utilizes the update wage 
calculation for exploratory purposes
...
## Set base seed
seed = 202111
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\2L_2S_even_w_update'
...
for ii in range(50):
    ...
    ## Add Housing
    test.addLocation(housing_elasticity = .5, local_ammenities = np.log(1), productivity_shifter = 1, location_ID = "Location 1")
    test.addLocation(housing_elasticity = .5, local_ammenities = np.log(1), productivity_shifter = 1, location_ID = "Location 2")
    ...
    test.addLabor(n_workers = n_labor,
                  location_prefs = {'Location 1': [-1, 1], 'Location 2': [-1, 1]}, 
