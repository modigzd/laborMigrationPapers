...
## Set base seed
seed = 202111
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\2L_2S_extra_empty_firms'
...
for ii in range(10):
    ...
    ## Add Housing
    test.addLocation(housing_elasticity = .5, local_ammenities = np.log(2), productivity_shifter = 3, location_ID = "Location 1")
    test.addLocation(housing_elasticity = .5, local_ammenities = np.log(4), productivity_shifter = 1.5, location_ID = "Location 2")
    ...
    test.addLabor(n_workers = n_labor,
                  location_prefs = {'Location 1': [-1, 1], 'Location 2': [-2, 2]}, 
