...
## Set base seed
seed = 202111
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\Tech_Restaurant_2L_w_agglom_2'
...
for ii in range(3):
    ...
    ## Add Housing
    test.addLocation(housing_elasticity = .5, local_ammenities = 1, productivity_shifter = 30, location_ID = "Location 1", gamma = gamma)
    test.addLocation(housing_elasticity = .5, local_ammenities = 2, productivity_shifter = 15, location_ID = "Location 2", gamma = gamma)
