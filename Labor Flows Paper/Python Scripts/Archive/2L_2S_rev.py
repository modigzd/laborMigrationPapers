...
## Set base seed
seed = 202111
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\2L_2S_rev'
...
for ii in range(50):
    ...
    test.addLocation(housing_elasticity = .5, local_ammenities = np.log(2), productivity_shifter = 3, location_ID = "Location 2")
