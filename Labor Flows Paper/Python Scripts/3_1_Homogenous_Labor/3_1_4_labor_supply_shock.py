# -*- coding: utf-8 -*-
"""
Replicate Section 3.1.3: Effect of a Labor Supply Shock on Wages and Prices

Here, run to equilibrium, then shock a location:
    - Increase A_c 
    - Increase A_ic as an extension (potentially)
...
Further, following Moretti, assume the two cities are identifical in period 1. Additionally:
    ...
    - set Productivity Shifter equal as well
...
## Set base seed
seed = 202207
write_path = r'C:\Users\zachm\Documents\George Mason\Projects\Labor Flows Paper\Results\3_1_Homogenous_Labor\3_1_4_labor_supply_shock'
...
for ii in range(50):   
    ...
    A_shock = 10
    world.Locations['Location B'].Ammenities = np.log(A_shock)       

    print('Shocking Ammenities in Location B: A_b = ' + str(A_shock))
